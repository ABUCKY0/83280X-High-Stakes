...
void initStyles() {
  ...
  box_color_temp_level1.body.main_color = LV_COLOR_MAKE(0xFF, 0xA5, 0x00);  // #FFA500
  box_color_temp_level1.body.grad_color = LV_COLOR_MAKE(0xFF, 0xA5, 0x00);  // #FFA500  
  // L2 is light red
  lv_style_copy(&box_color_temp_level2, &style_box);
  box_color_temp_level2.body.main_color = LV_COLOR_MAKE(0xFF, 0x00, 0x00);  // #FF0000
  box_color_temp_level2.body.grad_color = LV_COLOR_MAKE(0xFF, 0x00, 0x00);  // #FF0000
  // L3 is magenta
  lv_style_copy(&box_color_temp_level3, &style_box);
  box_color_temp_level3.body.main_color = LV_COLOR_MAKE(0xFF, 0x00, 0xFF);  //rgb(255, 0, 255)
  box_color_temp_level3.body.grad_color = LV_COLOR_MAKE(0xFF, 0x00, 0xFF);  // #FF00FF
  // L4 is violet
  lv_style_copy(&box_color_temp_level4, &style_box);
  box_color_temp_level4.body.main_color = LV_COLOR_MAKE(0x8A, 0x2B, 0xE2);  // #8A2BE2
  box_color_temp_level4.body.grad_color = LV_COLOR_MAKE(0x8A, 0x2B, 0xE2);  // #8A2BE2
