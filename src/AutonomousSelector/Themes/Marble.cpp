...
void initStyles() {
  ...
  style_confirmbtn.body.main_color = LV_COLOR_RED;
  style_confirmbtn.body.grad_color = LV_COLOR_RED;
  ...
  bg_image = marblebg;
  big_image = chicken_sandwich_nobg;
  small_image = MiniChickenSandwich;
