#include "AutonomousSelector/Themes/HelloKitty.hpp"  // IWYU pragma: keep
...
void initStyles() {
  ...
  big_image = transparent;
  small_image = hellokittyicon;
  ...
  style_btn.body.main_color = LV_COLOR_MAKE(0xe0, 0x56, 0x95);
  style_btn.body.grad_color = LV_COLOR_MAKE(0xe0, 0x56, 0x95);
  ...
  style_btn_selected.body.main_color = LV_COLOR_MAKE(0x76, 0x2f, 0x46);
  style_btn_selected.body.grad_color = LV_COLOR_MAKE(0x76, 0x2f, 0x46);
  ...
  style_confirmbtn.body.main_color = LV_COLOR_MAKE(0xe0, 0x56, 0x95);
  style_confirmbtn.body.grad_color = LV_COLOR_MAKE(0xe0, 0x56, 0x95);
  style_confirmbtn.body.radius = 8;
  style_confirmbtn.text.font = &font_btn_text;
  ...
  style_confirmbtn_selected.text.font = &font_btn_text;
  style_confirmbtn_selected.text.letter_space = .5;
  style_confirmbtn_selected.text.color = LV_COLOR_MAKE(0xe0, 0x56, 0x95);

  lv_style_copy(&style_teamname, &lv_style_plain);
  style_teamname.text.font = &font_team_name_text;
  style_teamname.text.color = LV_COLOR_GRAY;
  style_teamname.body.shadow.width = 15;              // Set shadow width
  style_teamname.body.shadow.color = LV_COLOR_GREEN;  // Set shadow color
  style_teamname.body.shadow.type = LV_SHADOW_FULL;
  ...
  style_buildtext.text.color = LV_COLOR_MAKE(0xe0, 0x56, 0x95);

  bg_image = hellokitty_bg;
