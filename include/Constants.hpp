...
#define PNEUMATIC_ADIPORT_SWEEPER        'b'
...
#define CONTROL_BUTTON_INTAKE_IN        E_CONTROLLER_DIGITAL_R2
#define CONTROL_BUTTON_INTAKE_OUT       E_CONTROLLER_DIGITAL_R1
...
#define CONTROL_BUTTON_FISHMECH_UP      E_CONTROLLER_DIGITAL_DOWN
#define CONTROL_BUTTON_FISHMECH_DOWN    E_CONTROLLER_DIGITAL_UP

#define CONTROL_BUTTON_SWEEPER_TOGGLE   E_CONTROLLER_DIGITAL_L1
#define CONTROL_BUTTON_SWEEPER_OUT      nullptr
#define CONTROL_BUTTON_SWEEPER_IN       nullptr

#define CONTROL_BUTTON_FISHMECH_OVERRIDE E_CONTROLLER_DIGITAL_A
#define CONTROL_BUTTON_FISHMECH_RESET   E_CONTROLLER_DIGITAL_Y
